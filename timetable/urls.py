...
urlpatterns = [
    ...
    path('universities/<int:pk>/', views.university_profile, name='university_profile'),
    ...
    path('admin/users/<int:pk>/', views.user_profile_admin, name='user_profile_admin'),
    ...
    path('cm/students/<int:pk>/edit/', views.cm_student_edit, name='cm_student_edit'),
    ...
    path('student/schedule/pdf/', views.student_schedule_pdf, name='student_schedule_pdf'),
    ...
    path('cm/dept-heads/<int:pk>/edit/', views.cm_dept_head_edit, name='cm_dept_head_edit'),
    ...
    path('api/public/colleges/', views.api_public_colleges, name='api_public_colleges'),
